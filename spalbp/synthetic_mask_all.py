...
def random_sample_data(batch_size, seq_len, low, high, offset=70):
...
def _train(cfg: RunConfig):
    ...
    for i in range(train_cfg.num_batches):
        ...
        data_sample = random_sample_data(
        ...
        seqs_inputs, attention_masks, targets = data_sample
        ...
        if i % train_cfg.validation_every == 0:
            model.eval()
            with torch.no_grad():
                eval_sample = random_sample_data(
                    train_cfg.batch_size,
                    cfg.experiment.context_size,
                    5,
                    cfg.experiment.num_classes,
                ...
                seqs_inputs, attention_masks, targets = eval_sample
